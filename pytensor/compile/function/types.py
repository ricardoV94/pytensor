...
class Function:
    ...
    def __init__(
        ...
        self._clear_input_storage_data = tuple(
            container.storage for container in input_storage if not container.implicit
        )
    ...
    def _validate_inputs(self, args, kwargs):
        ...
        for arg_container, arg in zip(input_storage, args):  # noqa: B905
            try:
    ...
    def __call__(self, *args, **kwargs):
        ...
        if self.trust_input:
            for storage_data, arg in zip(self._input_storage_data, args):  # noqa: B905
                storage_data[0] = arg
            if kwargs:  # for speed, skip the items for empty kwargs
