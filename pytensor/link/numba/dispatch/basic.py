...
def numba_njit_and_cache(op, *args, final_function: bool = True, **kwargs):
    """TODO: Docstrings"""
    ...
    if cache_key is None:
        ...
        if not final_function:
            ...
            return numba_njit(jitable_func, final_function=True, cache=False), None
    else:
        # To force numba to use our cache, we compile the function so that any closure
        # becomes a global variable. Otherwise, numba's cache is usually invalidated despite our efforts.
...
def numba_funcify_FunctionGraph(
    ...
    **kwargs,
    ...
    def op_conversion_and_key_collection(*args, **kwargs):
        ...
        # TODO: Test this is actually achieving anything instead of just
        # func, key = numba_funcify_and_cache_key(*args, **kwargs)
        func, key = numba_njit_and_cache(*args, final_function=False, **kwargs)
