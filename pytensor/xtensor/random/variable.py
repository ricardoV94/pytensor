...
from pytensor.tensor.random.variable import warn_reuse
...
XRandomGeneratorType.variable_type = XRandomGeneratorVariable
...
def rng(name=None) -> XRandomGeneratorVariable:
    ...
    (3,)
    """
    return xrandom_generator_type(name=name)
...
def shared_rng(
    ...
    >>> rng = pxr.shared_rng(seed=153, name="rng")
